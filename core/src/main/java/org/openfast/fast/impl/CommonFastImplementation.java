...
import org.openfast.codec.operator.NoneOperatorCodecFactory;
...
public abstract class CommonFastImplementation extends FastImplementation {
    ...
    protected void addParsers(List<FieldParser> parsers) {}
    ...
    public List<OperatorParser> getOperatorParsers() {
        if (operatorParsers == null) {
            ...
            addOperatorParsers(operatorParsers);
    ...
    public TypeRegistry getTypeRegistry() {
        if (typeRegistry == null) {
            ...
            addTypes(typeRegistry);
        }
        return typeRegistry;
    }

    protected void addTypes(TypeRegistry typeRegistry) {}
    ...
    public CodecFactory getCodecFactory() {
        if (codecFactory == null) {
            ...
            codecFactory.register("none", new NoneOperatorCodecFactory());
            addCodecFactories(codecFactory);
        }
        return codecFactory;
    }
    ...
    public TypeCodecRegistry getTypeCodecRegistry() {
        if (typeCodecRegistry == null) {
            ...
            addTypeCodecs(typeCodecRegistry);
        }
        return typeCodecRegistry;
    }

    protected void addTypeCodecs(TypeCodecRegistry typeCodecRegistry) {}
    ...
    public DictionaryTypeRegistry getDictionaryTypeRegistry() {
        if (dictionaryTypeRegistry == null) {
            ...
            addDictionaryTypes(dictionaryTypeRegistry);
        }
        return dictionaryTypeRegistry;
    }

    protected void addDictionaryTypes(DictionaryTypeRegistry dictionaryTypeRegistry2) {}
}
