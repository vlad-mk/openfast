...
public class BasicByteVectorCodecTest extends OpenFastTestCase {
    ...
    public void testEncode() {
        assertEquals("10000100 11111111 00111111 00001111 00000011", encode(new byte[] { (byte) 0xff, 0x3f, 0x0f, 0x03 }), 5);
        assertEquals("10000101 10001000 01100110 01000100 00100010 00000000", encode(new byte[] { (byte) 0x88, 0x66, 0x44, 0x22, 0x00 }), 6);
    }
